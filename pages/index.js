...
const Projectinformation = dynamic(()=>import("./projectcomponents/Projectinformation"),{ssr:false}); //Avoid hydration error by telling next to 
    ...
    <div className={darkMode ? "" : "dark"}>
      ...
      <main className="bg-white px-10 dark:bg-slate-800 ">
        <section className=" min-h-screen ">
          ...
          <div>
            <p className="flex justify-center text-slate-900 dark:text-gray-100 mb-28 ">
              Im a first year Systems Design Engineering student at the
              University of Waterloo currently searching for winter 2023 co-ops.
              <br />
              Im currently
            </p>
          </div>
